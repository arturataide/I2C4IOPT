...
/* Transition 10 - tr_10 */
extern int  t_10_enabled( simples_without_net_NetMarking* prev, simples_without_net_NetMarking* avail );
extern int  t_10_events( simples_without_net_InputSignalEvents* events );
extern int  t_10_guards( simples_without_net_NetMarking* marking, simples_without_net_InputSignals* inputs, simples_without_net_PlaceOutputSignals* place_out, simples_without_net_EventOutputSignals* ev_out );
extern void t_10_remove_marks( simples_without_net_NetMarking* marking );
extern void t_10_add_marks( simples_without_net_NetMarking* marking );
extern void t_10_generate_output_events( simples_without_net_OutputSignalEvents* ev_out );
