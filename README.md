...
##### Step2
Copy the GALS models ```*.zip``` files into "zip_files" folder prensent in the IOPT2AC_tool folders structure.
...
##### Step4
If the IOPT2AC_tool detects the correct number of models you are able to click in "Generate Arduino Files". As soon as the processes finishes the tool shows the models processed and their addresses.
<br><br>
<p align="center">
